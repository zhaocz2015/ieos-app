package com.wfzcx.ieos.ui.tablefixheader;
...
import com.wfzcx.ieos.ui.tablefixheader.adapters.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
    ...
    private OnCellClickLisenter onCellClickLisenter;

    public void setOnCellClickLisenter(OnCellClickLisenter onCellClickLisenter) {
        this.onCellClickLisenter = onCellClickLisenter;
    }
    ...
    private View makeView(int row, int column, int w, int h) {
        ...
        view.setOnClickListener(v -> {
            if (onCellClickLisenter != null) {
                onCellClickLisenter.cellClick(row, column);
            }
        });
