 ...
 * @date: 2016-09-13
 */
public class dz_macro_pro_elec_contrast_table extends BeamFragment {
    ...
    private String[] headerTitles = {"区域", "本期累计", "累计增幅"};
    private String[] columnLabels = {"name", "valCm", "valCmPy"};
