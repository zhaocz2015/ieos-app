 ...
 * @date: 2016-09-13
 */
public class dz_grad_enter_table extends BeamFragment {
    ...
    private String[] headerTitles = {"企业名称", "总计", "规模", "盈利能力", "成长性", "税收贡献"};
    private String[] columnLabels = {"dwmc", "total", "gmtotal", "yltotal", "cztotal", "sstotal"};
