 ...
 * @date: 2016-09-13
 */
public class dz_enter_region_table extends BeamFragment {
    ...
    private String[] headerTitles = {"区域", "企业户数", "本月", "本月增幅", "累计", "累计增幅"};
    private String[] columnLabels = {"regionname", "entcount", "valCm", "valCmPy", "valAcc", "valAccPy"};
