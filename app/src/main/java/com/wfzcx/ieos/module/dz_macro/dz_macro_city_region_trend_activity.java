 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_region_trend_activity extends BeamBaseActivity {
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_macro_city_region_trend_table fragment = new dz_macro_city_region_trend_table();
