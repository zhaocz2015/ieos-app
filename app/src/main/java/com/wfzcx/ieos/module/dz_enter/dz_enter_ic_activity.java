 ...
 * @date: 2016-09-13
 */
public class dz_enter_ic_activity extends BeamBaseActivity {
    ...
    private String curKpiName = "工业总产值";
...
//        mChart.setMarkerView(marker);
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_enter_ic_table fragment = new dz_enter_ic_table();
    ...
    private void renderData(int pos) {
        ...
        String whereSql = " b.dscode='DIRECTRPT' and b.dim_01 is not null and b.targetid = 13 ";
        if (!AccountModel.getInstance().getUsername().equals("dzs")) {
            whereSql = " b.dscode='DIRECTRPT' and b.dim_01 is not null and b.targetid = 13 and b.regionid = ( select s.regionid from ieos.sys_user s where s.username='" + AccountModel.getInstance().getUsername() + "') ";
        }
    ...
    private void renderData(String kpi) {
        ...
        Map<String, RequestBody> params = new HashMap<>();
        toolbarTitle.setText(AccountModel.getInstance().getUserCnname() + curNd + "年" + curYd + "月" + "产业集群主要经济指标分析(万元、%)");

        params.put("type", RequestBody.create(MediaType.parse("text/plain"), "dz_enter_ic_sql"));
