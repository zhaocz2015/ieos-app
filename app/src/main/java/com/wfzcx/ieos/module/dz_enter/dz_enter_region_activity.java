 ...
 * @date: 2016-09-13
 */
public class dz_enter_region_activity extends BeamBaseActivity {
...
//        mChart.setMarkerView(marker);
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_enter_region_table fragment = new dz_enter_region_table();
    ...
    private void renderData(int pos) {
        ...
        params.put("wheresql", RequestBody.create(MediaType.parse("text/plain"), " b.dscode='DIRECTRPT' and b.targetid = 13 "));
    ...
    private void renderData(String kpi) {
        ...
        Map<String, RequestBody> params = new HashMap<>();
        toolbarTitle.setText(AccountModel.getInstance().getRegionname() + curNd + "年" + curYd + "月" + "主要经济指标分析(万元、%)");
    ...
    private void renderChartData(List<Map> rsList) {
        ...
        mChart.getXAxis().setValueFormatter(new AxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                return rsList.get(index).get("regionname").toString();
            }
