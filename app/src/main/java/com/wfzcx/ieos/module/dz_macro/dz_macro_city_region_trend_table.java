 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_region_trend_table extends BeamFragment {
    ...
    private String[] headerTitles = {"时间", "企业户数", "累计", "累计增幅"};
    private String[] columnLabels = {"timeline", "amount", "valAcc", "valAccPy"};
