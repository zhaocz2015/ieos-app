 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_industry_activity extends BeamBaseActivity {
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_macro_city_industry_table fragment = new dz_macro_city_industry_table();
    ...
    private void renderData(String kpi) {
        ...
        params.put("type", RequestBody.create(MediaType.parse("text/plain"), "city_macro_industry_sql"));
