 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_material_activity extends BeamBaseActivity {
...
//        mChart.setMarkerView(marker);
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_macro_city_material_table fragment = new dz_macro_city_material_table();
    ...
    private void renderData(String kpi) {
        ...
        Map<String, RequestBody> params = new HashMap<>();
        toolbarTitle.setText(curNd + "年" + curYd + "月" + "原材料产业分析(" + curUnit + "、%)");

        params.put("type", RequestBody.create(MediaType.parse("text/plain"), "ht_macro_material_sql"));
    ...
    private void renderChartData(List<Map> rsList) {
        // 提出合计行
        Iterator<Map> it = rsList.iterator();
        while (it.hasNext()) {
            if ("合计".equals(it.next().get("yclname"))) {
                it.remove();
            }
        }
        ...
        mChart.getXAxis().setValueFormatter(new AxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                return rsList.get(index - 1).get("yclname").toString();
            }
