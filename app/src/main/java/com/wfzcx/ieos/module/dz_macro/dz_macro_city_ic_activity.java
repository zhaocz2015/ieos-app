 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_ic_activity extends BeamBaseActivity {
...
//        mChart.setMarkerView(marker);
    ...
    private void renderViewPager() {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                dz_macro_city_ic_table fragment = new dz_macro_city_ic_table();
    ...
    private void renderData(int pos) {
        ...
        params.put("wheresql", RequestBody.create(MediaType.parse("text/plain"), " b.dscode = 'ICSTATE' "));
    ...
    private void renderData(String kpi) {
        ...
        Map<String, RequestBody> params = new HashMap<>();
        toolbarTitle.setText(curNd + "年" + curYd + "月" + "产业集群分析(亿元、%)");

        params.put("type", RequestBody.create(MediaType.parse("text/plain"), "city_macro_ic_sql"));
    ...
    private LineData generateLineData(List<Map> rsList) {
        ...
        for (int index = 0; index < rsList.size() - 1; index++) {
            if (rsList.get(index + 1).get("valAccPy") == null) {
                entries.add(new Entry(index + 1f, 0f));
            } else {
