 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_elec_trend_table extends BeamFragment {
    ...
    private String[] headerTitles = {"时间", "本月", "本月增幅", "本月累计", "累计增幅"};
    private String[] columnLabels = {"timeline", "valCm", "valCmPy", "valAcc", "valAccPy"};
