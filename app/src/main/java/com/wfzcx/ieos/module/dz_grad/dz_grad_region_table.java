 ...
 * @date: 2016-09-13
 */
public class dz_grad_region_table extends BeamFragment {
    ...
    private String[] headerTitles = {"区域", "总计", "工业规模", "质量效益", "发展潜力"};
    private String[] columnLabels = {"dwmc", "total", "gygmtotal", "zlxytotal", "fzqltotal"};
