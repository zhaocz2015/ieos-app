 ...
 * @date: 2016-09-13
 */
public class dz_macro_city_material_table extends BeamFragment {
    ...
    private String[] headerTitles = {"原材料产业", "累计", "累计增幅"};
    private String[] columnLabels = {"yclname", "valacc", "valaccpy"};
